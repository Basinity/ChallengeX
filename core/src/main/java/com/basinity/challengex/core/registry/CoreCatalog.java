...
public final class CoreCatalog {
    ...
    private static void registerTriggers(Registry<TriggerDefinition> registry) {
        ...
        trigger(registry, "item_dropped", true, optional("item", STRING));
        trigger(registry, "food_eaten", true, optional("item", STRING));
        trigger(registry, "xp_gained", true);
        trigger(registry, "advancement_earned", true, optional("advancement", STRING));
        ...
        trigger(registry, "enchantment_applied", true, optional("enchantment", STRING), optional("level", INT));
        trigger(registry, "item_smelted", true, optional("item", STRING));
        trigger(registry, "projectile_shot", true, optional("projectile", STRING));
        trigger(registry, "mob_tamed", true, optional("mob", STRING));
        trigger(registry, "mob_bred", true, optional("mob", STRING));
        trigger(registry, "container_opened", true, optional("container", STRING));
        trigger(registry, "item_used", true, optional("item", STRING));
        trigger(registry, "block_interacted", true, optional("block", STRING));
        trigger(registry, "started_gliding", true);
        trigger(registry, "mounted", true, optional("mob", STRING));
        trigger(registry, "effect_gained", true, optional("effect", STRING));
        trigger(registry, "tool_broke", true, optional("item", STRING));
    ...
    private static void registerEffects(Registry<EffectDefinition> registry) {
        effect(registry, "apply_status_effect", true, required("effect", STRING), optional("duration", INT), optional("amplifier", INT).bounded(1, 256));
        ...
        effect(registry, "give_item", true, required("item", STRING), optional("amount", INT).bounded(1, 64));
        ...
        effect(registry, "spawn_mob", true, required("mob", STRING), optional("count", INT).bounded(1, 100), optional("baby", BOOL));
    ...
    private static void registerModifiers(Registry<ModifierDefinition> registry) {
        ...
        modifier(registry, "status_effect", true, required("effect", STRING), optional("amplifier", INT).bounded(1, 256));
