...
public final class CoreCatalog {
    ...
    private static void registerTriggers(Registry<TriggerDefinition> registry) {
        ...
        trigger(registry, "level_interval", true, required("level", INT));
    ...
    private static void registerEffects(Registry<EffectDefinition> registry) {
        ...
        effect(registry, "spawn_mob", true, required("mob", STRING), optional("count", INT), optional("baby", BOOL));
        ...
        effect(registry, "falling_anvil", true, optional("height", INT));
        ...
        effect(registry, "repair_held_item", true, optional("amount", INT));
        effect(registry, "damage_held_item", true, optional("amount", INT));
